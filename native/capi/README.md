...
```sh
curl -LO https://github.com/insatomcat/open61850/releases/download/v0.7.0/libopen61850-0.7.0-x86_64-linux-gnu.tar.gz
tar xzf libopen61850-0.7.0-x86_64-linux-gnu.tar.gz
export PKG_CONFIG_PATH=$PWD/libopen61850-0.7.0-x86_64-linux-gnu/lib/pkgconfig
